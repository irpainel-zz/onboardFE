//
//  ConfirmPasswordTextFieldView.m
//  
//
...
@implementation ConfirmPasswordTextFieldView
...
-(void)initialSetup{
    ...
    [self setPlaceholderWithString:[Message messageWithKey:@"textfield.placeholder.confirm_password"]];
    [self setRequired:YES];
    [self setKeyboardType:UIKeyboardTypeDefault andSecureTextEntry:YES];
}

-(void)setupLabel{
    [self setLabelString:[Message messageWithKey:@"textfield.label.confirm_password"]];
}
